...
void		FragTrap::rangedAttack(const std::string& target){
	...
	std::cout << "FR4G-TP " << this->__Name << " tring to attack {" << target << "} at range. Gotcha! causing "
	<< this->__RangedAttackDamage << " points of damage!" << std::endl;
}
void		FragTrap::meleeAttack(const std::string& target){

	std::cout << "FR4G-TP " << this->__Name << " tring to attack {" << target << "} at melee. Gotcha! causing "
...
void		FragTrap::beRepaired(unsigned int amount){
	...
	std::cout << "FR4G-TP {" << this->__Name << "} is healing {" << amount
	<< "} HP and have {"<< this->__HitPoints << "} hp now!" << std::endl;
}
